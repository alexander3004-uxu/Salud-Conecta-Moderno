...
const translations: Translations = {
  es: {
    ...
    'footer.emergency.desc': 'Si siente que su vida está en peligro o tiene síntomas críticos, no use esta herramienta y llame de inmediato al 911.',
  ...
  en: {
    ...
    'footer.emergency.desc': 'If you feel your life is in danger or have critical symptoms, do not use this tool and call 911 immediately.',
