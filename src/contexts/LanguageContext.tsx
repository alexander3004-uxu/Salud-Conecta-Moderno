...
const translations: Translations = {
  es: {
    ...
    'ai.status.model': 'Modelo: Gemini 3 Flash',
    ...
    'maps.key_required.desc': 'Para ver los hospitales y centros de salud en Nicaragua, necesitamos una API Key válida.',
  ...
  en: {
    ...
    'ai.status.model': 'Model: Gemini 3 Flash',
    ...
    'maps.key_required.desc': 'To view hospitals and health centers in Nicaragua, we need a valid API Key.',
