          ...
          <div className="flex items-center px-4 py-3 hover:bg-[#202C33] cursor-pointer bg-[#2A3942] transition-colors">
            ...
            <div className="flex-1 border-b border-[#222D34] pb-3">
              <div className="flex justify-between items-center mb-1">
                <span className="font-bold text-base text-[#DAE2FD]">Salud Conecta IA</span>
      ...
      <main className="flex-1 flex flex-col h-full bg-[#0B141A] relative shadow-2xl">
          ...
          <div className="flex items-center gap-4 cursor-pointer">
            ...
            <div>
              <div className="flex items-center gap-1.5">
                <h2 className="font-bold text-base text-[#DAE2FD]">Salud Conecta IA</h2>
                <BadgeCheck className="w-4 h-4 text-[#00A884] fill-[#00A884]/20" />
              </div>
              <p className="text-[11px] font-bold text-[#8696A0] uppercase tracking-widest">Empresa oficial</p>
            </div>
          </div>
          <div className="flex gap-6 text-[#8696A0]">
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-8 flex flex-col gap-3 custom-scrollbar wa-chat-bg">
          ...
          <div className="flex justify-center mb-4">
            <span className="bg-[#182229] text-[#8696A0] text-[11px] font-bold px-4 py-1.5 rounded-lg shadow-sm border border-[#222D34]">Hoy</span>
          </div>
          ...
          <div className="flex justify-center mb-6">
            <div className="bg-[#182229]/80 backdrop-blur-sm text-[#FFD279] text-[11px] px-4 py-3 rounded-xl max-w-[90%] md:max-w-[70%] text-center shadow-sm flex items-start gap-3 border border-[#FFD279]/10">
              ...
              <p className="leading-relaxed">Las llamadas y mensajes a esta empresa ahora están cifrados de extremo a extremo. Toca para más información.</p>
            </div>
          </div>
          ...
          <div className="flex mb-4 group">
            <div className="bg-[#202C33] rounded-2xl md:rounded-tl-none p-0 max-w-[95%] md:max-w-[450px] shadow-lg relative overflow-hidden flex flex-col border border-[#404753]/30">
               ...
               <div className="bg-[#222D34] px-4 py-3 flex items-center gap-3 border-b border-[#404753]/20">
                ...
                <div>
                  <h3 className="font-bold text-xs text-[#DAE2FD] leading-tight">Salud Conecta IA</h3>
                  <p className="text-[10px] text-[#8696A0] font-medium">Confirmación de Cita Médica</p>
                </div>
              </div>

              {/* Message Content */}
              <div className="px-4 py-4 text-sm text-[#DAE2FD] leading-relaxed">
                <p className="mb-4">Hola. Te contactamos de <strong>Salud Conecta IA</strong> para confirmar tu próxima cita médica.</p>
                ...
                <div className="bg-[#182229] rounded-xl border border-[#404753]/20 p-4 mb-4 flex flex-col gap-3 shadow-inner">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <span className="text-[10px] font-bold text-[#8696A0] uppercase tracking-wider block mb-0.5">Especialista</span>
                      <strong className="text-sm font-bold text-[#DAE2FD]">Dr. Carlos Mendoza</strong>
                      <p className="text-[11px] text-[#8696A0]">Cardiología</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <Calendar className="w-4 h-4 text-secondary shrink-0 mt-1" />
                    <div>
                      <span className="text-[10px] font-bold text-[#8696A0] uppercase tracking-wider block mb-0.5">Fecha y Hora</span>
                      <strong className="text-sm font-bold text-[#DAE2FD]">Viernes, 15 Noviembre</strong>
                      <p className="text-[11px] text-[#8696A0]">09:00 AM</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-4">
                  <div className="flex items-start gap-4 bg-[#182229] p-4 rounded-xl border border-primary/10">
                    ...
                    <div>
                      <span className="text-[10px] font-bold text-[#8696A0] uppercase tracking-wider block mb-1">Ubicación</span>
                      <p className="text-[#DAE2FD] font-medium leading-snug mb-2">Hospital Central, Torre B, Consultorio 402.</p>
                ...
                <div className="mb-4 border-l-[3px] border-[#F04438] bg-[#F04438]/5 p-4 rounded-r-xl">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <strong className="text-[#F04438] text-[11px] font-black uppercase tracking-widest">Instrucciones importantes</strong>
                  </div>
                  <ul className="list-disc list-inside text-[#C0C7D5] text-xs space-y-1.5 decoration-[#F04438]/30">
                    <li>Presentarse con <strong>ayuno de 8 horas</strong>.</li>
                    <li>Llevar <strong>estudios previos</strong> relevantes.</li>
                    <li>Llegar 15 minutos antes.</li>
                  </ul>
                </div>

                <p className="text-xs text-[#8696A0] mb-2 font-medium">Por favor, confirma tu asistencia usando el botón de abajo.</p>
          ...
          <div className="flex justify-end mb-4 animate-in slide-in-from-right duration-500 delay-700 fill-mode-both">
            <div className="bg-[#005C4B] rounded-2xl rounded-tr-none py-2 px-3 md:px-4 max-w-[85%] shadow-lg relative border border-[#00A884]/10">
              <p className="text-sm text-[#E9EDEF] inline-block mr-12 leading-relaxed">Perfecto, allí estaré. Muchas gracias por el recordatorio.</p>
