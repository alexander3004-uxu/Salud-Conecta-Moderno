    ...
    <div className="w-full max-w-7xl mx-auto px-4 md:px-6 mb-12">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <motion.div 
          ...
          className="bg-surface-container-low border border-primary/20 rounded-[32px] p-6 shadow-xl flex flex-col justify-between"
        >
        ...
        <motion.div 
          ...
          className={`bg-surface-container-low border rounded-[32px] p-6 shadow-xl flex flex-col justify-between ${
            isPremium ? 'border-secondary/40' : 'border-outline-variant/30'
          }`}
        >
          <div className="flex items-center justify-between mb-4">
            <div className={`p-3 rounded-2xl border ${isPremium ? 'bg-secondary/20 text-secondary border-secondary/30' : 'bg-surface-container-high text-outline-variant border-outline-variant/30'}`}>
              <Globe className="w-6 h-6" />
            </div>
            <div className="flex items-center gap-2">
              {isPremium ? <Unlock className="w-3 h-3 text-secondary" /> : <Lock className="w-3 h-3 text-outline-variant" />}
              <span className={`px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest border ${
                isPremium ? 'bg-secondary/20 text-secondary border-secondary/30' : 'bg-surface-container-highest text-outline-variant border-outline-variant/30'
              }`}>
          ...
          <div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <span className={`text-[10px] font-mono font-bold uppercase tracking-wider ${isPremium ? 'text-secondary font-black' : 'text-outline-variant'}`}>
